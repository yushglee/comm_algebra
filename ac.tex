...
\begin{proof}
	...
	and apply the theorem to $I=\fm A$ yields
	\[
...
\begin{proof}
	Since $k$ is a field,  $M\otimes_Ak$ is trivially flat over  $k$.
	To use (i)(ii), need  $\Tor_1(M,k)=0$.
	Let  $x_1,\cdots,x_r$ be a regular parameters of $A$.
	Then
	 \[
		 \dim_B(M/(x_1,\cdots,x_r)M)=\dim_B(M)-\dim(A)
	\]
	so $(x_1,\cdots,x_r)$ is a $M$-regular sequence.
	Define  $M_i=M/(x_1,\cdots,x_i), A_i=A/(x_1,\cdots,x_i)$
	and show inductively that $\Tor_1(M,A_i)=0$.
\end{proof}
